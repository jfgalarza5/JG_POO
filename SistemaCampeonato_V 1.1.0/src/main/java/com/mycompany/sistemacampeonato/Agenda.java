...
public class Agenda {
    ...
    public void guardarAgenda(){
        try(BufferedReader br=new BufferedReader(new FileReader("C:\\Users\\johng\\OneDrive\\Escritorio\\Gestion Campeonato\\Agenda.txt"))){
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\johng\\OneDrive\\Escritorio\\Gestion Campeonato\\Agenda.txt"));
            int count=0;
            bw.write("===AGENDA===");
            bw.newLine();
            for(String e:fecha){
                count++;
                indice=fecha.indexOf(e);
                bw.write("Partido "+count+"     Fecha: "+e+"    Encuentro: "+partido.get(indice));
                bw.newLine();
            }
            bw.flush();
            System.out.println("Guardado exitosamente en el archivo C:\\Users\\johng\\OneDrive\\Escritorio\\Gestion Campeonato\\Agenda.txt");
        }catch(IOException e){
